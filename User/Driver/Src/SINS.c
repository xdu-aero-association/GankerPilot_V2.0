...
void  SINS_Prepare(void)
{
  ...
  */
  ...
  Body_Frame.x=LPButterworth(accel.x,&accel_feedback_filter_buf[0],&Butter_10HZ_Parameter_Acce);
  Body_Frame.y=LPButterworth(accel.y,&accel_feedback_filter_buf[1],&Butter_10HZ_Parameter_Acce);;
  Body_Frame.z=LPButterworth(accel.z,&accel_feedback_filter_buf[2],&Butter_10HZ_Parameter_Acce);;
  Vector_From_BodyFrame2EarthFrame(&Body_Frame,&Earth_Frame);
...
#define SPL06_Sync_Cnt  3//30
#define HCSR04_Sync_Cnt 1//0
