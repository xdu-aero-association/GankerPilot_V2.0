...
const float Control_Unit[18][20]=
{
  ...
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,500 ,0  ,0 , 300,  0.75   ,3.00  ,1.00  ,0  ,0 , 500,  1 ,  1 ,  1 },//Pitch_Gyro;偏航角速度
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,30  ,0  ,0 , 80,   4.00   ,0.00  ,0.00  ,0  ,0 , 450,  1 ,  1 ,  1 },//Roll_Angle;横滚角
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,500 ,0  ,0 , 300,  0.75   ,3.00  ,1.00  ,0  ,0 , 500,  1 ,  1 ,  1 },//Roll_Gyro;横滚角速度
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,45  ,0  ,0 , 150 , 4.00   ,0.00  ,0.00  ,0  ,0 , 450,  1 ,  1 ,  1 },//Yaw_Angle;偏航角
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,300 ,0  ,0 , 200,  1.50   ,1.00  ,0.00  ,0  ,0 , 500,  1 ,  1 ,  1 },//Yaw_Gyro;偏航角速度 
  //定高参数
...
void Total_PID_Init(void)
{
  ...
  Set_Cutoff_Frequency(WP_Duty_Freq, 5 ,&Control_Device_Err_LPF_Parameter);
