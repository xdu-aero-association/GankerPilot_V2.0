...
/*****************遥控器行程设置**********************/
int16_t Motor_PWM_1,Motor_PWM_2,Motor_PWM_3,Motor_PWM_4;//六4个电机输出PWM
...
void Throttle_Angle_Compensate()//油门倾角补偿
{
  ...
  if(Throttle>=Thr_Start)//大于起转油门量
  {
    ...
    Throttle_Makeup=(Throttle-Thr_Start)*Temp*temp_gain;//油门倾角补偿
...
******************************************************************/
uint16_t Idel_Cnt=0;
#define Idel_Transition_Gap 2//怠速递增间隔时间 2*5=10ms
