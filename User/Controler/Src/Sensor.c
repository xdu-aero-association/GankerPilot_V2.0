...
Butter_BufferData ins_accel_filter_buf2[3],ins_accel_filter_buf[3],gyro_filter_buf_bug[3],gyro_filter_buf[3],accel_filter_buf[3],mag_filter_buf[3],accel_cal_filter_buf[3],accel_for_cal_filter_buf[3];
...
//	ins_accel_filter.x=BTfilter(&Accel_X_INS_ButterFilter,accel.x);
//	ins_accel_filter.y=BTfilter(&Accel_Y_INS_ButterFilter,accel.y);
//	ins_accel_filter.z=BTfilter(&Accel_Z_INS_ButterFilter,accel.z);				
...
volatile float beta=0.0075f;//0.0075f;//0.01
                              ...
                              float gyro_mold) 
{
  ...
  {   
    ...
    beta_temp=beta+0.035f*IMU_Dt*constrain_float(gyro_mold,0,500);//0.025
